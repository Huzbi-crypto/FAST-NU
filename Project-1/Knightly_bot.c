// Knight_bot
// This is a chatbot with various operations that it can perform. It has a
// converter, it can fetch html file, it can give basic answers. While it has
// some limited features since C itself cannot really support the actual
// chatbot's features and libraries this shows that it is possible to create a
// chatbot that you can use in your everday life to make it easier, productive,
// and most of all, FUN!
/*
       Made by TMG-sub:
